...
3. Run `runner.py` with `GENERATE_LAT = True` to generate LAT questions.
4. Modify and run `do_probability_estimates.py` to estimate the probability of Do(X) corresponding with a change in another causal mechanism Y.
5. 
